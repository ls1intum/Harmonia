 ...
 * Acts as a facade that delegates to specialized services and coordinates
 ...
 *       {@link AnalysisResultPersistenceService}</li>
 * </ol>
 */
@Service
@Slf4j
public class RequestService {
    ...
    public Optional<ClientResponseDTO> runSingleTeamAIAnalysis(Long exerciseId, Long teamId) {
        return persistenceService.runSingleTeamAIAnalysis(exerciseId, teamId, transactionTemplate);
    }
