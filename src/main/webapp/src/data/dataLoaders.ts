...
export function transformToComplexTeamData(dto: ClientResponseDTO): Team {
  ...
  const showPairProgramming =
    hasScoredPairProgrammingStatus || pairProgrammingStatus === 'NOT_FOUND' || pairProgrammingStatus === 'WARNING';
          ...
          ? [
              {
                ...
                value: hasScoredPairProgrammingStatus
                ...
                details: hasScoredPairProgrammingStatus
