...
// ============================================================
async function fetchBasicTeamsFromAPI(
    course: string,
    exercise: string
): Promise<BasicTeamData[]> {
...
async function fetchComplexTeamsFromAPI(
    course: string,
    exercise: string
): Promise<ComplexTeamData[]> {
    // TODO: Replace with actual API endpoint
 ...
 */
export async function loadBasicTeamData(
    course: string,
    exercise: string
): Promise<BasicTeamData[]> {
    if (USE_DUMMY_DATA) {
 ...
 */
export async function loadComplexTeamData(
    course: string,
    exercise: string
): Promise<ComplexTeamData[]> {
    if (USE_DUMMY_DATA) {
