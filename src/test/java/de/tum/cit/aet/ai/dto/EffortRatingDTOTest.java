...
class EffortRatingDTOTest {
    ...
    void testWeightedEffort_highQuality() {
        ...
        EffortRatingDTO rating = new EffortRatingDTO(
                8.0, 8.0, 9.0, CommitLabel.FEATURE, 0.95, "Complex new feature", false, null);
    ...
    void testWeightedEffort_lowQuality() {
        ...
        EffortRatingDTO rating = new EffortRatingDTO(
                7.0, 2.0, 1.0, CommitLabel.TRIVIAL, 0.8, "Copy-paste code", false, null);
    ...
    void testWeightedEffort_minimum() {
        // Minimum scores
        EffortRatingDTO rating = new EffortRatingDTO(
                1.0, 1.0, 1.0, CommitLabel.TRIVIAL, 1.0, "Trivial change", false, null);
    ...
    void testWeightedEffort_maximum() {
        // Maximum scores
        EffortRatingDTO rating = new EffortRatingDTO(
                10.0, 10.0, 10.0, CommitLabel.FEATURE, 1.0, "Perfect work", false, null);
    ...
    void testAllCommitLabels() {
        for (CommitLabel label : CommitLabel.values()) {
            EffortRatingDTO rating = new EffortRatingDTO(
                    5.0, 5.0, 5.0, label, 0.9, "Test", false, null);
