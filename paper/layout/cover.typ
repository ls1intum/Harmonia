...
#let cover(
  ...
  v(2mm)
  align(center, text(font: fonts.sans, 1.2em, weight: 100, "Applied Education Technologies"))
  
  v(15mm)

  align(center, text(font: fonts.sans, 1.3em, weight: 100, degree + " Paper — " + program))
  v(15mm)
  ...
  v(10mm)
  align(center, text(font: fonts.sans, 1.2em, weight: 500, author))
}